...
SELECT * FROM tb_produtos where preco < 5.00 and cagoria_id =2;

SELECT * FROM tb_produtos where preco < 5.00 or cagoria_id =2;
...
SELECT * FROM tb_produtos where preco between 3 and 5;
